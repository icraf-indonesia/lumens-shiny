---
title: "PreQUES-Land Use/Cover Change Analysis"
output: 
  html_document:
    toc: true
    toc_float: true
...
## Land Use/Cover Map for Year `r time_1`
...
## Land Use/Cover Map for Year `r time_2`
...
```{r}
kable(ques_pre_output[["input_dataviz"]][["lc_composition_tbl"]], 
      caption = "Land Use/Cover Composition") %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
```
...
### Table of Top 10 Types of Land Use/Cover Changes

```{r}
kable(ques_pre_output[["landscape_level"]][["luc_top_10_tbl"]], 
      caption = "Top 10 Types of Land Use/Cover Changes") %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
```

### Graph of Top 10 Types of Land Use/Cover Changes
...
# Pre-QuES Land Use/Cover Trajectory Analysis (FAO)
...
lookup_traj <-
  cats(traj_map)[[1]] %>%
  left_join(color_landuse_trajectories(), by = "trajectory")
...
### Summary of Pre-QuES Land Use/Cover Change Trajectories
...
```{r child_document_traj_def, echo=FALSE, fig.keep='all', results='asis'}
