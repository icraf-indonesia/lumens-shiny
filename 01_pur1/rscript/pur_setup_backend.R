...
# create central attribute of planning units for reconciliation -----------
...
# for output handling using rgdal writeOGR
PUR_rec1 <- PUR
...
# fix orphaned holes (must be tested using other data)
# PUR_rec1_shp <- rgeos::gBuffer(PUR_rec1_shp, byid = T, width = 0)
# cbind(PUR_rec1_shp, df_levels)
...
# saveRDS(ref, paste0(LUMENS_path_user, "/pur_ref.rds"))
# saveRDS(lookup_ref, paste0(LUMENS_path_user, "/pur_lookup_ref.rds"))
# saveRDS(PUR_stack, paste0(LUMENS_path_user, "/pur_stack.rds"))
# saveRDS(db_final2, paste0(LUMENS_path_user, "/pur_database_final.rds"))
# saveRDS(wd_user, paste0(LUMENS_path_user, "/pur_wd_user.rds"))
# saveRDS(proj.file, paste0(LUMENS_path_user, "/pur_proj.file.rds"))
# saveRDS(pu_lut_list, paste0(LUMENS_path_user, "/pur_pu_lut_list.rds"))
# saveRDS(database_unresolved_out, paste0(LUMENS_path_user, "/pur_database_unresolved_out.rds"))
# saveRDS(run_time, paste0(LUMENS_path_user, "/pur_runtime.rds"))
# 
# file.copy(paste0(LUMENS_path, "\\template", "\\pur_build_report.qmd"), wd_user, recursive = FALSE, overwrite = TRUE)
# 
# 
# library(quarto)
# quarto_render(paste0(wd_user, "/pur_build_report.qmd"),
#               output_format = "html")
# 
# print(colnames(database_unresolved_out))
