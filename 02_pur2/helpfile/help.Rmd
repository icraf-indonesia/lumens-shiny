...
2.  Unresolved Case Attribute (Excel format)
    ...
    -   Before running PUR Reconcile module, it is necessary to select the reconcile action on drop-down option for every unresolved case in 'PUR_unresolved_case.xlsx' file generated from PUR Build module. You can use Microsoft Excel or any free spreadsheet software (e.g., Google Sheet) to do it.
