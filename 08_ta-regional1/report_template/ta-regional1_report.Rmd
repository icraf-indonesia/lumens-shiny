...
dt_multiplier <- params$multiplier %>%
  mutate(
    ...
    Lab.multiplier = formatC(Lab.multiplier, format = "e", digits = 3)
  )
...
### Income Multiplier
This reflects how much additional input a sector demands from others. Sectors with high income multipliers create substantial demand for upstream products.
