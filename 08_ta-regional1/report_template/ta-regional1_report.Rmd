...
DT::datatable(params$Linkages_table)
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
DT::datatable(params$P.sector.selected)
```

## Analysis of GDP 
### Sectoral GDP Table
```{r, echo=FALSE, warning=FALSE, message=FALSE}
DT::datatable(params$GDP)
```
...
### Sectoral Multiplier
```{r, echo=FALSE, warning=FALSE, message=FALSE}
DT::datatable(params$multiplier)
```
...
```{r, echo=FALSE, warning=FALSE, message=FALSE}
DT::datatable(params$land.requirement_table)
```
