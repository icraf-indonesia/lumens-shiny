...
if (params$multiseries == "two_step"){
  ...
  res = knitr::knit_child(
    text = c(
      ...
      "C factor map generated based on land cover/use",
      "```{r, fig.width=12}",
      "#| echo=FALSE",
      "plot(c[[i]], colNA = NULL)",
      "```"
...
if (params$multiseries == "two_step") {
  ...
  datatable(
    ...
    caption = htmltools::tags$caption(
      style = 'caption-side: top; text-align: left; color:black;  font-size:150% ;', 'Soil Erosion Changes at Landscape Level in ', paste0(params$t1), '-', paste0(params$t2))
  ) %>%
    formatRound(
      columns = "Percentage (%)",
      digits = 2
...
if (params$multiseries == "two_step"){
  ...
  datatable(
    e_pu_diff_table, 
    caption = htmltools::tags$caption(
      style = 'caption-side: top; text-align: left; color:black;  font-size:150% ;', 'Soil Erosion Changes at Planning Unit Level in ', paste0(params$t1), '-', paste0(params$t2)))
}
```
------------------------------------------------------------------------
