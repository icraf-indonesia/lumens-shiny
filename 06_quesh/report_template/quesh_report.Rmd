    ...
    text = c(
      ...
      if (content_type == "Map of Soil Erosion Changes") {
        ...
        c(
          ...
          "  caption = tags$caption(",
          "    style = 'caption-side: top; text-align: left; color:black; font-size:150%;',",
          "    paste('Soil Erosion Changes (Ha) at Planning Unit Level in', params$t1, '-', params$t2)",
          "  )",
          ")"
        )
        ...
        c(
          ...
          "mutate(across(where(is.numeric), scales::comma))",
          "datatable(",
          "  e_stats, caption = tags$caption(",
          "    style = 'caption-side: top; text-align: left; color:black; font-size:150%;',",
          "    paste('Soil Erosion Changes (Ha) Statistic at Planning Unit Level in', params$t1, '-', params$t2)",
          "    )",
          ")"
        )
      },
