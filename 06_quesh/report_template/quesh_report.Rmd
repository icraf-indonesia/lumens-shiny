...
```{r Digital Elevation Model, echo=FALSE}
...
```{r Planning Unit, echo=FALSE, fig.width=10, fig.align='left'}
...
```{r C Factor, echo=FALSE, fig.width=10, fig.align='left'}
...
```{r Soil Erosion Estimation Map, echo=FALSE, fig.width=10, fig.align='left'}
...
```{r Soil Erosion Difference Map, echo=FALSE, fig.width=10, fig.align='left'}
