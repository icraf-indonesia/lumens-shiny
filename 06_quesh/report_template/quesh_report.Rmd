...
render_child <- function(content_type) {
  res = knitr::knit_child(
    text = c(
      ...
      } else if (content_type == "Map of Soil Erosion Changes at Planning Unit Level") {
        c(
...
if (params$multiseries == "two_step") {
  ...
  render_child("Map of Soil Erosion Changes at Planning Unit Level")
}
```

```{r soil erosion stats, echo=FALSE, fig.width=12, fig.align='left', warning=FALSE, message=FALSE}
