...
Carbon map illustrating the distribution and amount of carbon stored in land use/cover data at `r params$p1` (in tonne-C ha<sup>-1</sup>).
...
Carbon map illustrating the distribution and amount of carbon stored in land use/cover data at `r params$p2` (in tonne-C ha<sup>-1</sup>).
...
Emission map illustrating a decrease in carbon stock amount (in tonne CO<sub>2</sub>-eq ha<sup>-1</sup>).
...
Sequestration map illustrating an increase in carbon stock amount (in tonne CO<sub>2</sub>-eq ha<sup>-1</sup>).
...
The map below shows the average carbon emission rates (tonne CO<sub>2</sub>-eq ha<sup>-1</sup> yr<sup>-1</sup>) across planning units, representing the release of carbon from land cover changes. Darker areas indicate higher emission levels.
...
The map below shows the average carbon sequestration rates (tonne CO<sub>2</sub>-eq ha<sup>-1</sup> yr<sup>-1</sup>) across planning units, indicating increases in above-ground carbon stocks due to land cover changes. Darker greens represent higher sequestration levels.
