...
## Carbon density map in `r nrow(params$p1)`
...
## Carbon density map in `r nrow(params$p2)`
...
Emission map illustrating a decrease in carbon stock amount from land use/cover T1 to land use/cover T2 (in tonne CO~2~eq).
...
Sequestration map illustrating an increase in carbon stock amount from land use/cover T1 to land use/cover T2 (in tonne CO~2~eq).
