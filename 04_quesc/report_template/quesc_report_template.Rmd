...
z$tb_em_total_10_summary %>%
  kbl(caption = "The Largest Source of Emission", escape = F) %>%
  kable_paper("hover", full_width = F)
```
...
z$tb_sq_total_10_summary %>%
  kbl(caption = "The Largest Source of Sequestration", escape = F) %>%
  kable_paper("hover", full_width = F)
```
