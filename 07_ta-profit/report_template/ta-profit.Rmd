...
### NPV Distribution Map for Year `r params$year1`
...
### NPV Distribution Map for Year `r params$year2`
...
for (pu_name in names(params$pu_outputs)) {
  render_child_pu(params$pu_outputs, pu_name)
}
```
