...
quesb_app <- function() {
  ...
  required_packages <- c("terra", "dplyr", "ggplot2", "shiny", "shinyjs", "shinyFiles")
  ...
  ui <- fluidPage(
    ...
    fluidRow(
      column(8, offset = 2,
             fileInput("lc_t1", "Land Cover T1", accept = c(".tif", ".tiff")),
             fileInput("lulc_lut", "Land Use/Cover Lookup Table (CSV)", accept = c(".csv")),
