...
analysis_log <- tribble(
  ...
  "1. Raster inputs lookup", params$inputs$path_lookup_raster_inputs,
  "2. Crop suitability parameters", params$inputs$path_lookup_crop_suitability,
  "3. Intervention lookup", params$inputs$path_lookup_intervention,
  "Outputs", "",
  "Output Workspace", params$inputs$path_output,
  "Session Summary", ""
